<template>
  <NuxtLink class="max-w-fit my-5 px-8 border-2 rounded-full flex flex-row items-center gap-10 hover:bg-gray-100">
      <span class="inline-block relative btn-svg ">
	<svg width="25" height="24" viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg" focusable="false" data-icon="github" role="img" class="m-auto text-black">

...
// Image preloading
//
//const preloadedImages = ref(new Array(props.images.length).fill(null) as HTMLImageElement[])
//
//async function preloadImage(index: Number): Promise<HTMLImageElement> {
//  const image = props.images[index]
//  const img = await $image.fetch(`${props.path}${image.file}`)
//  preloadedImages.value[index] = (img)
//  return img
//}
//
//onMounted(() => {
//  props.images.forEach((_, index) => preloadImage(index))
//})
//function isImageLoaded(index: Number): boolean {
//  return preloadedImages.value[index] != null
//}
//
//function getPreloadedImageSrc(index: Number): string {
//  return preloadedImages.value[index]
//}
